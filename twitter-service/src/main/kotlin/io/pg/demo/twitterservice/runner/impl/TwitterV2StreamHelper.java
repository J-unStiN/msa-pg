...
public class TwitterV2StreamHelper {
    ...
    public TwitterV2StreamHelper(TwitterServiceConfigData twitterToKafkaServiceConfigData,
                                 TwitterKafkaStatusListener twitterKafkaStatusListener) {
        this.twitterServiceConfigData = twitterToKafkaServiceConfigData;
    ...
    void connectStream(String bearerToken) throws IOException, URISyntaxException, JSONException {
        ...
        URIBuilder uriBuilder = new URIBuilder(twitterServiceConfigData.getTwitterV2BaseUrl());
    ...
    private void createRules(String bearerToken, Map<String, String> rules) throws URISyntaxException, IOException {
        ...
        URIBuilder uriBuilder = new URIBuilder(twitterServiceConfigData.getTwitterV2RulesBaseUrl());
